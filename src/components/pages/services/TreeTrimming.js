    ...
    return (
        <main id="TreeTrimming">
            ...
            <section className="bg-gray-100 py-12 flex flex-col md:flex-row items-center">
                ...
                <h2 className="text-2xl text-green-700 font-bold mb-4 md:text-justify text-center">TREE TRIMMING</h2>
